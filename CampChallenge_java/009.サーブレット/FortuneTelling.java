...
public class FortuneTelling extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        final String result ="/WEB-INF/jsp/FortnneTellongResult.jsp";
        
        String lack[] ={"大吉","中吉","小吉","吉","半吉","末小吉","凶","小凶","半凶","末凶","大凶"};
        Random rand = new Random();
        Integer index=rand.nextInt(lack.length);
    
         ResultData data =new ResultData();
         data.setD(new Date());
         data.setLuck(lack[index]);
